...
export default function PostCard({ post }: PostCardProps) {
  ...
  return (
    <article className="card-panel p-5 transition hover:-translate-y-0.5 hover:shadow-soft">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <span className="rounded-full border border-accent/30 bg-accent/10 px-3 py-1 text-xs text-accent">{post.desired_level}</span>
      </div>
