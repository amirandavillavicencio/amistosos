...
import { getClubStatsRanking, getRecentResults, getSuggestedMatches } from '@/lib/data';
import type { ClubStatsCard, MatchResultRow, SuggestedMatchCard } from '@/lib/types';
...
export default async function HomePage() {
  ...
  try {
    const [matches, topRanking, results] = await Promise.all([
